...
eslintTester.addRuleTest('./lib/rules/require-jsdoc', {
    ...
    invalid: [
        ...
        {
            code: '/*@param [type] */function doSomething(string) {return string}',
            errors: [ { message: 'Autogenerated @jsdoc comment for doSomething' } ]
        },
        {
            code: '/*@param [decription] */ function doSomething(string) {return string}',
            errors: [ { message: 'Autogenerated @jsdoc comment for doSomething' } ]
        }
    ]
});
