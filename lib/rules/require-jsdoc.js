...
module.exports = function (context) {
  ...
  var AUTO_REGEX = /\[description\]|\[type\]/;
  ...
  function containsAutogeneratedComment(comment) {
    return comment.match(AUTO_REGEX);
  }
  ...
  function displayWarning(error, node, id) {
    switch (error) {
      ...
      case 'no-param':
            ...
            break;
      case 'auto-gen':
            context.report(node, 'Autogenerated @jsdoc comment for ' + id.name);
            break;
  ...
  return {
    ...
    'FunctionExpression': function(node){
      ...
      if(containsAutogeneratedComment(comment)) {
        displayWarning('auto-gen', node, refNode[key]);
      }
    }
  };
};
